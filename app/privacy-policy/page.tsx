          ...
          <div className="prose prose-lg max-w-none space-y-8">
            <section>
              ...
              <p className="text-foreground/80 leading-relaxed">
                SWISS POLL INTERNATIONAL ("we," "our," or "us") is committed to protecting your privacy. This Privacy
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2 text-foreground/80">
                ...
                <li>Survey Responses: Data collected through our research studies</li>
