...
// // Color constants (red primary, green for Methodology, blue for charts)
// const ACCENT_COLOR = "#D64541"; // primary red
// const ACCENT_COLOR_LIGHT = "#D6454133"; // 20% opacity of red
// const CHART_COLOR = "#2563EB"; // blue for charts
// const SECTION_BG_LIGHT = "#FFF5F5"; // very light red/pink background
// const SECTION_BG_DARK = "#0F5132"; // deep green for "The Science of Certainty."
// const SECTION_BG_NEUTRAL = "#EFF6FF"; // light blue neutral background
...
// const segmentData = [
//   { name: "Millennials", value: 35, color: CHART_COLOR },
//   { name: "Gen X", value: 28, color: "#60A5FA" }, // lighter blue
//   { name: "Boomers", value: 22, color: "#93C5FD" }, // soft blue
//   { name: "Gen Z", value: 15, color: ACCENT_COLOR }, // red accent
// ];
...
//                       <Button
//                       variant="outline"
//                       className="transition-all duration-300 hover:scale-105 bg-white border-gray-300 text-black hover:border-accent hover:text-white"
...
const SUCCESS_GREEN = "#059669"; // Professional green for success/positive elements
const TRUST_BLUE = "#2563EB"; // Trustworthy blue for key sections
const PRIMARY_RED_LIGHT = "#DC262633"; // 20% opacity
const SUCCESS_GREEN_LIGHT = "#05966933"; // 20% opacity
const TRUST_BLUE_LIGHT = "#2563EB33"; // 20% opacity

// Section backgrounds
const SECTION_BG_LIGHT = "#F8FAFC"; // Light blue-gray
const SECTION_BG_DARK = "#1E293B"; // Dark blue-gray
const SECTION_BG_NEUTRAL = "#FFFFFF"; // Clean white

// Fake data for charts with new colors
const trendData = [
  { month: "Jan", approval: 45, disapproval: 35 },
  { month: "Feb", approval: 48, disapproval: 32 },
  { month: "Mar", approval: 52, disapproval: 30 },
...
const segmentData = [
  { name: "Millennials", value: 35, color: PRIMARY_RED },
  { name: "Gen X", value: 28, color: TRUST_BLUE },
  { name: "Boomers", value: 22, color: SUCCESS_GREEN },
  { name: "Gen Z", value: 15, color: "#7C3AED" }, // Purple for variety
];
                ...
                >
                  <CardContent className="pt-8 pb-6 text-center">
                    <div
                      ...
                      style={{
                        backgroundColor:
                          feature.color === PRIMARY_RED
                            ? PRIMARY_RED_LIGHT
                            : feature.color === SUCCESS_GREEN
                            ? SUCCESS_GREEN_LIGHT
                            : TRUST_BLUE_LIGHT,
                      }}
                    >
                ...
                >
                  <div className={isReverse ? "lg:order-2" : ""}>
                    <div
                      ...
                      style={{
                        backgroundColor:
                          service.color === PRIMARY_RED
                            ? PRIMARY_RED_LIGHT
                            : service.color === SUCCESS_GREEN
                            ? SUCCESS_GREEN_LIGHT
                            : TRUST_BLUE_LIGHT,
                      }}
                    >
                    ...
                    <Button
                      variant="outline"
                      className="transition-all duration-300 hover:scale-105 bg-white border-gray-300 text-gray-700 hover:border-gray-400 hover:bg-gray-50"
                      onClick={handleOpenPdfModal}
                    >
                      See Sample Report{" "}
                      <ArrowRight size={16} className="ml-2" />
        ...
        <div className="container mx-auto px-4 lg:px-8">
          ...
          <div className="max-w-6xl mx-auto">
            <div className="relative mb-16 lg:mb-20">
              ...
              <div
                className="hidden md:block absolute left-8 right-8 top-8 h-0.5"
                style={{ backgroundColor: TRUST_BLUE_LIGHT }}
              />
                  ...
                  <Button
                    className={`w-full transition-all duration-300 hover:scale-105 ${
                      insight.action === "download"
                        ...
                        : insight.action === "read"
                        ? "bg-white border-gray-300 text-gray-700 hover:border-green-600 hover:bg-green-600 hover:text-white"
                    ...
                    style={
                      insight.action === "download"
                        ? {
                            backgroundColor: insight.color || PRIMARY_RED,
                          }
                        : insight.action === "read"
                        ? {}
                        : {}
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button
                size="lg"
                className="text-white text-lg px-10 py-6 transition-all duration-300 hover:scale-105 hover:bg-red-700"
                style={{ backgroundColor: PRIMARY_RED }}
                onClick={() => router.push("/contact")}
              >
                Contact Our Research Team
