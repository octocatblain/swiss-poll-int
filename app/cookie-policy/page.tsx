    ...
    <div className="min-h-screen">
      ...
      <main className="pt-32 pb-24">
        <div className="container mx-auto px-4 lg:px-8 max-w-4xl">
          <h1 className="text-5xl font-bold text-primary mb-8">Cookie Policy</h1>
          ...
          <div className="prose prose-lg max-w-none space-y-8">
            ...
            <section>
              ...
              <p className="text-foreground/80 leading-relaxed mb-4">
                SWISS POLL INTERNATIONAL uses cookies for the following purposes:
              </p>
              <ul className="list-disc pl-6 space-y-2 text-foreground/80">
                ...
                <li>
                  <strong>Marketing Cookies:</strong> Track your browsing habits to deliver relevant advertising
                </li>
              </ul>
            </section>
            ...
            <section>
              ...
              <p className="text-foreground/80 leading-relaxed">
                ...
                impact your user experience and some functionality may no longer be available. Most browsers allow you
                to refuse or accept cookies through their settings.
              </p>
            </section>
