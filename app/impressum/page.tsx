            ...
            <CardContent className="p-8 space-y-8">
              ...
              <section>
                ...
                <div className="space-y-2 text-foreground/80">
                  ...
                  <p>
                    <strong>Email:</strong>{" "}
                    <a href="mailto:info@swisspollinternational.ch" className="text-primary hover:underline">
                      info@swisspollinternational.ch
                    </a>
                  </p>
                  <p>
                    <strong>Website:</strong>{" "}
                    <a href="https://www.swisspollinternational.ch" className="text-primary hover:underline">
              ...
              <section>
                <h2 className="text-2xl font-bold text-primary mb-4">Management</h2>
                <div className="space-y-2 text-foreground/80">
                  <p>
              ...
              <section>
                <h2 className="text-2xl font-bold text-primary mb-4">Supervisory Authority</h2>
                <div className="space-y-2 text-foreground/80">
              ...
              <section>
                <h2 className="text-2xl font-bold text-primary mb-4">Professional Memberships</h2>
                <div className="space-y-2 text-foreground/80">
                  <p>ESOMAR (European Society for Opinion and Marketing Research)</p>
              ...
              <section>
                ...
                <p className="text-foreground/80 leading-relaxed">
                  ...
                  pages. All information is subject to change without notice.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-foreground/80 leading-relaxed">
                  © 2025 SWISS POLL INTERNATIONAL AG. All rights reserved. The content and works on these pages created
                  by the site operators are subject to Swiss copyright law.
                </p>
              </section>
            </CardContent>
          </Card>
